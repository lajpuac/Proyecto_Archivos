   ...
   private ArrayList<PDF> data;
    ...
    public Datos() throws FileNotFoundException, IOException {
       ...
       // jTable1.setDefaultEditor(Object.class, null);
        ...
        LectorPDF Datos = new LectorPDF();
        if (Datos.VerificarDatos() == false) {
            this.AgregarCarpetaPDF();
        }
        this.getData();
    }
    public void getData() throws FileNotFoundException, IOException {
        PDF nuevo=new PDF();
        LectorPDF aux =new LectorPDF();
       
        //jTable1.getTableHeader().setFont(new Font("Arial", 1, 13));
        jTextField1.add(this, nuevo.getTamañoArchivo());
        jTextField2.add(this, nuevo.getTamañoPagina());
        jTextField3.add(this, nuevo.getNumeroPagina());
        jTextField4.add(this, nuevo.getTitulo());
        jTextField5.add(this, nuevo.getAsunto());
        jTextField6.add(this, nuevo.getPalabrasClave());
        jTextField7.add(this, nuevo.getTipoArchivo());
        jTextField8.add(this, nuevo.getVersionpdf());
        jTextField9.add(this, nuevo.getAplicacion());
        RandomAccessFile lectura = new RandomAccessFile("PDF.data", "rw");
        ...
        for (int i = 0; i < lectura.length(); i++) {//Recorre el archivo para obtener los indices
            ...
            String datos = new String(caracteres);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lector de Metadatos");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("Tamaño del Archivo");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Tamaño de Página");
        ...
        jLabel8.setText("Tipo de Archivo PDF");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel9.setText("Versión de PDF");

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setText("Aplicación con la que fue creada");
    ...
    public void AgregarCarpetaPDF() throws IOException {
        JFileChooser jf = new JFileChooser();
        jf.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
        FileNameExtensionFilter fi = new FileNameExtensionFilter(".PDF", ".pdf");
        jf.showSaveDialog(null);
        LectorPDF lee = new LectorPDF(jf.getSelectedFile().getAbsolutePath());
        lee.SaveInformation();
    }
